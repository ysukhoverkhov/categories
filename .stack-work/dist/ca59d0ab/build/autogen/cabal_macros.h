...
/* package categories-0.1.0.0 */
#define VERSION_categories "0.1.0.0"
#define MIN_VERSION_categories(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "categories-0.1.0.0-IevDMGzmhguG7PYc24GvUR"

#define CURRENT_PACKAGE_KEY "categories-0.1.0.0-IevDMGzmhguG7PYc24GvUR"
